...
// Handle removing all documents
DocumentHandler.prototype.handleReset = function(request, response) {
  console.lo
  this.store.flush( function(ret) {
      winston.warn('flushing database database');
      response.writeHead(200, { 'content-type': 'application/json' });
